...
class DetailsController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $detail -> designation_name	 = $request -> designation_name	;
        $detail -> image = $imgUrl;
        $detail -> full_description = $request -> full_description;
        $detail -> status = $request -> status;
        $detail ->save();

        return redirect()->back()->with('message','Teacher Add Succesfully');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/manage-details')->with('message','Teacher Data Update Successfully');
    }  
    public function delete($id)
    {
        ...
        return redirect('/manage-details')->with('message','Teacher Data Remove Successfully');
    }
}
